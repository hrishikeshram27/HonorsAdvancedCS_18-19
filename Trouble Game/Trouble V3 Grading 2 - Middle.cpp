...
void Board::execute(){
    ...
    //cin>>numPlay;
    players[0].setx(5); players[0].sety(8); players[0].setDist(12);
    players[1].setx(2); players[1].sety(2); players[1].setDist(3);
    players[2].setx(8); players[2].sety(8); players[2].setDist(21);
    players[4].setx(2); players[4].sety(8); players[4].setDist(21);
    players[5].setx(2); players[5].sety(7); players[5].setDist(20);
    players[6].setx(4); players[6].sety(8); players[6].setDist(5);
    players[7].setx(3); players[7].sety(8); players[7].setDist(4);
    while(game){
