...
void Board::display(){
    ...
    cout<<"G";
    gotoxy(6*(4-1)+3,3*(2-1)+2);
    cout<<"C";
    gotoxy(6*(8-1)+3,3*(4-1)+2);
    cout<<"C";
    gotoxy(6*(2-1)+3,3*(6-1)+2);
    cout<<"C";
    gotoxy(6*(6-1)+3,3*(8-1)+2);
    cout<<"C";
    for(int i=0;i<8;i++){
...
void Board::execute(){
    ...
    //cin>>numPlay;
    players[0].setx(5); players[0].sety(2); players[0].setDist(0); //T1
    players[1].setx(8); players[1].sety(2); players[1].setDist(21); //T2
    players[2].setx(8); players[2].sety(5); players[2].setDist(0); //R1
    players[3].setx(7); players[3].sety(5); players[3].setDist(-1); //R2
    players[4].setx(5); players[4].sety(8); players[4].setDist(0); //B1
    players[5].setx(8); players[5].sety(8); players[5].setDist(3); //B2
    players[6].setx(2); players[6].sety(4); players[6].setDist(23); //L1
    players[7].setx(2); players[7].sety(3); players[7].setDist(22); //L2
    while(game){
        for(int i=0;i<4;i++){ //always 4 players for this grading scenario
            system("CLS");
            display();
